		...
		<form action="" method="post" enctype="multipart/form-data">	
			...
			<div class="w3l-mail">
				...
				<div class="w3l-options1">
					<select class="category1" name=ptype required="">
			...
			<div class="w3l-details1">
				<div class="w3l-num">
					...
					<input type="text"  name="stayplan" placeholder="" required="">
				</div>
				<div class="w3l-date">
					<label class="head">Price<span class="w3l-star"> * </span></label>
						<div class="styled-input">
							<input class="date" id="" name="price" type="text" >
						</div>
					</div>	
			<div class="clear"></div>
			...
			<div class="w3l-rem">
				<div class="w3l-right">
					...
					<textarea name=pdetails rows="5" cols="30"></textarea>
				</div>	
				<div class="w3l-right">
					<label class="w3l-set2">Inclusions</label>
					<textarea name=inclusions rows="5" cols="30"></textarea>
				</div>	
				<div class="w3l-right">
					<label class="w3l-set2">Exclusions</label>
					<textarea name=exclusions rows="5" cols="30"></textarea>
				</div>	
				<div class="w3l-right">
