	...
	<div class="w3l-from">
		<form action="" method="post" enctype="multipart/form-data">	
			...
			<div class="w3l-rem">
				...
				<input type="file" value="<?php echo $result['image']?>" name="file" size="50">
				</div>
				<div class="btn">
...
if(isset($_POST["submit"]))
{
	...
	$sql="update package set `pname`='$pname', `ptype`='$ptype', `stayplan`='$stayplan', `price`='$price', `pdetails`='$pdetails',`inclusions`='$inclusions',`exclusions`='$exclusions', `about`='$about' 'where pid=$pid;";
